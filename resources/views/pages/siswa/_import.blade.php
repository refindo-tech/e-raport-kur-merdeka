      ...
      <div class="modal-content">
          ...
          @csrf
            ...
            <div class="modal-body">
              ...
              <b>Ketentuan Pengisian Data Excel:</b>
              <br>•	Format pengisian harus sesuai dengan catatan tiap kolom
              <br>•	Kolom Hijau opsional, boleh kosong/boleh diisi
              <br>•	Kolom Kuning wajib diisi
              <br>•	Kolom yang terdapat ^ harus unik, tidak boleh ada yang kembar
