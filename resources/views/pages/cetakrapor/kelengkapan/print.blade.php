    ...
    <div style="padding-top: 15px; font-size: 16px;">
      <table>
        ...
        <tr style="line-height: 25px;">
          ...
          {{-- Start New Code --}}
          @php
          $tanggal = $siswa->diterimaditanggal ? Str::before($siswa->diterimaditanggal, ' ') : null;
          try {
            $formattedTanggal = $tanggal ? Carbon::createFromFormat('Y-m-d', $tanggal)->locale('id')->isoFormat('D MMMM YYYY') : null;
          } catch (\Exception $e) {
          ...
          {{-- Start Old Code --}}
          {{-- <td>{{ Carbon::createFromFormat('Y-m-d', Str::before($siswa->diterimaditanggal, ' '))->locale('id')->isoFormat('D MMMM YYYY') }}</td> --}}
          {{-- End Old Code --}}
      ...
      <table style="padding-top: 30px;">
        <tr>
          ...
          <td style="width: 40%; font-size: 16px;">
            ...
            {{-- Start New Code --}}
            @php
            $tempat = $siswa->kelas->tapel->tempat ?? '................,';
            $tanggalDiterima = $siswa->diterimaditanggal ? Str::before($siswa->diterimaditanggal, ' ') : ' ................................';
            try {
              $formattedTanggal = $tanggalDiterima 
              ? Carbon::createFromFormat('Y-m-d', $tanggalDiterima)->locale('id')->isoFormat('D MMMM YYYY') 
              : ' ................................';
            } catch (\Exception $e) {
              $formattedTanggal = ' ................................';
            }
            @endphp
            {{ $tempat }}, {{ $formattedTanggal }}<br>
            {{-- End New Code --}}
            
            {{-- Start Old Code --}}
            {{-- {{$siswa->kelas->tapel->tempat}}, {{ Carbon::createFromFormat('Y-m-d', Str::before($siswa->diterimaditanggal, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal'}}, <br> --}}
            {{-- End Old Code --}}
