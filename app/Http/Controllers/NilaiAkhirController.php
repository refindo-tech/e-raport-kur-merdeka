          ...
          foreach ($request->siswa_id as $i => $siswaId) {
            ...
            if ($request->$reqNilai !== null) {
                NilaiAkhir::create([
                    ...
                    'deskripsi_capaian_tinggi' => $request->has($capaianOptimal) ? 'menunjukkan penguasaan yang baik dalam ' . $deskripsiCapaianTinggi : null,
                    'deskripsi_capaian_rendah' => $request->has($capaianKurang) ? 'menunjukkan penguasaan yang baik dalam ' . $deskripsiCapaianRendah : null,
                ]);
            }
          }
        DB::commit();
